...
Total: **$67.78** — exact match to the captured saveAs body at `/tmp/aws_calc_onboard/awsCloudTrail.json` (extracted from `captures/calculator.aws_new.har`, request index 346, posted to `dnd5zrqcec4or.cloudfront.net/Prod/v2/saveAs`).
