...
- Captured saveAs body: `/home/fahadmustafa/src/aws-calc/captures/saveAs/per-service/awsElasticDisasterRecovery.json`
- Service template (en_US definition with the SPA's verbatim math operations): extracted from `/home/fahadmustafa/src/aws-calc/captures/calculator.aws_new_2.har`, response for `https://d1qsjq9pzbk1k6.cloudfront.net/data/awsDrsRecoveryReplication/en_US.json` (version `0.0.37`)
