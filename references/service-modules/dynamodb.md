...
- **Source capture**: `captures/saveAs/per-service/amazonDynamoDb.json` (local capture, not in repo) — a full DynamoDB line item with all 8 sub-services in `us-east-2`, parent `serviceCost = {"monthly": 604.47, "upfront": 180}`.
